...
namespace Repository {
    ...
    public partial class InventoryDataSet : global::System.Data.DataSet {
        ...
        public partial class ProductDataTable : global::System.Data.TypedTableBase<ProductRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ProductRow AddProductRow(int ProductId, string Name, int Quantity) {
        ...
        public partial class OrderDataTable : global::System.Data.TypedTableBase<OrderRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public OrderRow AddOrderRow(ProductRow parentProductRowByFK_Order_Order, int Quantity) {
                ...
                if ((parentProductRowByFK_Order_Order != null)) {
                    columnValuesArray[1] = parentProductRowByFK_Order_Order[0];
                }
...
namespace Repository.InventoryDataSetTableAdapters {
    ...
    public partial class ProductTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Product] SET [ProductId] = @ProductId, [Name] = @Name, [Quantity] = @Quantity WHERE (([ProductId] = @Original_ProductId) AND ([Name] = @Original_Name) AND ([Quantity] = @Original_Quantity));
SELECT ProductId, Name, Quantity FROM Product WHERE (ProductId = @ProductId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Repository.Properties.Settings.Default.InterviewConnectionString;
        }
        ...
        public virtual int Delete(int Original_ProductId, string Original_Name, int Original_Quantity) {
        ...
        public virtual int Insert(int ProductId, string Name, int Quantity) {
        ...
        public virtual int Update(int ProductId, string Name, int Quantity, int Original_ProductId, string Original_Name, int Original_Quantity) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, int Quantity, int Original_ProductId, string Original_Name, int Original_Quantity) {
    ...
    public partial class OrderTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Order] WHERE (([OrderId] = @Original_OrderId) AND ([ProductId]" +
                " = @Original_ProductId) AND ([Quantity] = @Original_Quantity))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Order] ([ProductId], [Quantity]) VALUES (@ProductId, @Quantity" +
                ");\r\nSELECT OrderId, ProductId, Quantity FROM [Order] WHERE (OrderId = SCOPE_IDEN" +
                "TITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@ProductId", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "ProductId", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Quantity", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Quantity", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Order] SET [ProductId] = @ProductId, [Quantity] = @Quantity WHERE (([OrderId] = @Original_OrderId) AND ([ProductId] = @Original_ProductId) AND ([Quantity] = @Original_Quantity));
SELECT OrderId, ProductId, Quantity FROM [Order] WHERE (OrderId = @OrderId)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@ProductId", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "ProductId", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Quantity", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Quantity", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT OrderId, ProductId, Quantity FROM dbo.[Order]";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int ProductId, int Quantity, int Original_OrderId, int Original_ProductId, int Original_Quantity, int OrderId) {
            this.Adapter.UpdateCommand.Parameters[0].Value = ((int)(ProductId));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int ProductId, int Quantity, int Original_OrderId, int Original_ProductId, int Original_Quantity) {
            return this.Update(ProductId, Quantity, Original_OrderId, Original_ProductId, Original_Quantity, Original_OrderId);
        }
    }
